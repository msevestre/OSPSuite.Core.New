# OSPSuite.PKParameters

List of PK parameters supported by the Open Systems Pharmacology Suite
...
## License
OSPSuite.PKParameters is released under the [GPLv2 License](LICENSE).
